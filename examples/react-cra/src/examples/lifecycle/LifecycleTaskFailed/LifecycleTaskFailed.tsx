...
import { promiseSeries, dummyTask, SeriesReport, SeriesStateReport } from '../../../libs/promiseSeries';
import { Column, Button, UL, LI } from '../../../styles/FlexStyles';

export const LifecycleTaskFailed = () => {
  const defaultState = {
    results: [],
    error: null,
  };
  ...
  const onTaskError = (report: SeriesStateReport) =>
    console.log('onTaskError: ', report);
