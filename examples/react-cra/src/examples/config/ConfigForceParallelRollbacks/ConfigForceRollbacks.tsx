...
export const ConfigForceParallelRollbacks = () => {
  const defaultState = {
    results: [],
    error: null,
    basket: {
  ...
  const rollbacks = {
    ...
    getOranges: async () => await dummyTask({ delay, shouldFail: true })
      .then(results => {
  ...
  return (
    <Column style={{ flex: 1, display: 'block' }}>
      <h1>Comming Soon: forceParallelRollbacks</h1>
